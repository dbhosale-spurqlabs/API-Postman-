Feature: Upload Sell Offer NDA Document API Validation
  ...
  Scenario Outline: Validate POST Upload Sell Offer NDA Document API Response for "<scenarioName>" Scenario
    ...
    Examples:
      ...
      | Valid request   | POST   | /api/v2/sell-offers/{id}/nda-document  | NA            | NA        | Upload_Sell_Offer_NDA_Document_200| 200        | Upload_Sell_Offer_NDA_Document_Schema_200| json     | id,name,type,size,uploadedAt,uploadedBy,lastModifiedAt           |
