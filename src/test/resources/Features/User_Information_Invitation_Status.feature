Feature: User Information Invitation Status API Validation

  @api

  Scenario Outline: Validate GET User Information Invitation Status API Response for "<scenarioName>" Scenario
