Feature: Upload Sell Offer Deal Document API Validation
  ...
  Scenario Outline: Validate POST Upload Sell Offer Deal Document API Response for "<scenarioName>" Scenario
    ...
    Examples:
      ...
      | Valid request   | POST   | /api/v2/sell-offers/{id}/deal-document  | NA            | NA        | Upload_Sell_Offer_Deal_Document_200| 500        | Upload_Sell_Offer_Deal_Document_Schema_200| json     | id,name,type,size,uploadedAt,uploadedBy,lastModifiedAt           |
