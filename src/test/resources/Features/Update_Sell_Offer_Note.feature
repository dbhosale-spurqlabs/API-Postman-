Feature: Update Sell Offer Note API Validation
  ...
  Scenario Outline: Validate PUT Update Sell Offer Note API Response for "<scenarioName>" Scenario
    ...
    Examples:
      ...
      | Valid request   | PUT    | /api/v2/sell-offers/{id}/notes/{noteId}| NA            | NA        | Update_Sell_Offer_Note_200| 500        | Update_Sell_Offer_Note_Schema_200| json     | id,content,isPinned,createdAt,createdBy,updatedAt        |
