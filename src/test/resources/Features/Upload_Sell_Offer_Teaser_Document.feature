Feature: Upload Sell Offer Teaser Document API Validation

  @api
  Scenario Outline: Validate POST Upload Sell Offer Teaser Document API Response for "<scenarioName>" Scenario
